...
type WorkloadEntryApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v1beta1.WorkloadEntry `json:"spec,omitempty"`
...
func (b *WorkloadEntryApplyConfiguration) WithZZZ_DeprecatedClusterName(value string) *WorkloadEntryApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
