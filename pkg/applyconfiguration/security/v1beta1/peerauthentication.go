...
func (b *PeerAuthenticationApplyConfiguration) WithSelfLink(value string) *PeerAuthenticationApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	b.SelfLink = &value
	return b
}
...
func (b *PeerAuthenticationApplyConfiguration) WithZZZ_DeprecatedClusterName(value string) *PeerAuthenticationApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
