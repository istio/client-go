...
type Interface interface {
	// TrafficExtensions returns a TrafficExtensionInformer.
	TrafficExtensions() TrafficExtensionInformer
...
// TrafficExtensions returns a TrafficExtensionInformer.
func (v *version) TrafficExtensions() TrafficExtensionInformer {
	return &trafficExtensionInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
